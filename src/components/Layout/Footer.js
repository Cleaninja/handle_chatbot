...
export default function Footer() {
  return (
    <div className="mx-auto py-12 px-4 md:px-8 lg:px-10 xl:px-20 justify-between w-full bg-[#CCD3E1] z-20">
      <div className="border-b border-b-black pb-4">
        <div>
          ...
          <p className="w-1/3 pt-4 font-bold">
            One of the leading solution providers in European countries for
            high-performance advertising campaigns on social channels that help
            our clients to get more qualified applicants and more growth.
          </p>
        </div>
