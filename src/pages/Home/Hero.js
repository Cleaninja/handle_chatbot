...
export default function Hero() {
  return (
    <div className="w-full bg-[#CCD3E1]">
      <div className="max-w-[1600px] mx-auto pt-24 md:pt-40 pb-20 px-4 md:px-8 lg:px-10 xl:px-20 ">
        <Row gutter={[12, 12]}>
          <Col xs={24} sm={24} md={24} lg={12}>
            <h1 className="md:leading-none text-[#21272A] font-extrabold text-left text-5xl md:text-6xl md:text-[70px]">
              Tourism Jobs-
              ...
              >
                {slides.map((item, index) => (
                  <SwiperSlide key={index}>
                    <img
                      className="rounded-lg w-[80%] mx-auto h-full"
